...
baseline_blue=input("left end of the baseline area : ")
baseline_red=input("right end of the baseline area : ")
...
nopeak_blue=input("left end of the peakless area : ")
nopeak_red=input("right end of the peakless area : ")


print("Please input a wavelength corresponding to the top of an absorbance peak used for scaling : ")
scaling_top=input("top of the peak : ")
