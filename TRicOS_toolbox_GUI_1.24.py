...
class LeftPanel(GenPanel):
    ...
    def __init__(self, parent):
        ...
        self.sizer_checkboxes.Add(self.TRicOS_checkbox, flag=wx.ALL, border=5)
        self.sizer_checkboxes.Add(self.FLUO_checkbox, flag=wx.ALL, border=5)
        ...
        # constboxsizer.Add(constchecksizer, 1, wx.ALIGN_CENTER | wx.ALL, border = 2)
        ...
        UVsizer.Add(self.field_weighUV, 1, wx.ALIGN_CENTER | wx.BOTTOM, border=3)
        ...
        # fieldscatsizer.Add(self.field_nopeak_blue, 0, wx.ALIGN_CENTER | wx.ALL, border = 0)
        # fieldscatsizer.Add(self.label_nopeak_blue, 0, wx.ALIGN_CENTER, border = 0)
        # fieldscatsizer.Add(self.field_nopeak_red, 0, wx.ALIGN_CENTER | wx.ALL, border = 0)
        # fieldscatsizer.Add(self.label_nopeak_red, 0, wx.ALIGN_CENTER, border = 0)
        # fieldscatsizer.Add(self.label_leeway_factor, 0, wx.ALIGN_CENTER, border = 0)
        # fieldscatsizer.Add(self.field_leeway_factor, 0, wx.ALIGN_CENTER | wx.ALL, border = 0)
